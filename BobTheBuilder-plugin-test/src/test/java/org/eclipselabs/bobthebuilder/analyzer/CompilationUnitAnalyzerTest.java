...
import org.eclipselabs.bobthebuilder.analyzer.CompilationUnitAnalyzerImpl.Analyzed;
...
public class CompilationUnitAnalyzerTest {
  ...
  public void setUp() throws Exception {
    ...
    when(builderType.getElementName()).thenReturn(CompilationUnitAnalyzerImpl.BUILDER_CLASS_NAME);
  ...
  public void testNullRequest() throws Exception {
    ...
    new CompilationUnitAnalyzerImpl().analyze(compilationUnit);
  }
  ...
  public void testNoBuilder() throws Exception {
    ...
    Analyzed actual = new CompilationUnitAnalyzerImpl().analyze(compilationUnit);
