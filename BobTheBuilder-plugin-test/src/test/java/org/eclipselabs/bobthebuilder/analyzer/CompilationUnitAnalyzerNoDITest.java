...
public class CompilationUnitAnalyzerNoDITest {
  @Mock
  ...
  public void setUp() throws Exception {
    ...
    compilationUnitAnalyzer = new CompilationUnitAnalyzer(new TypeAnalyzer(),
        new BuilderTypeAnalyzer(), new BuilderTypeFieldAnalyzer(), new MainTypeFieldAnalyzer(),
