...
import org.eclipselabs.bobthebuilder.handlers.CompilationUnitAnalyzer;
import org.eclipselabs.bobthebuilder.handlers.CompilationUnitAnalyzer.Analyzed;
...
public class CompilationUnitAnalyzerTest {
  ...
  public void testNoBuilder() throws Exception {
    ...
    Analyzed actual = new CompilationUnitAnalyzer(compilationUnit).analyze();
